/*
 * Configuration settings for the Variscite VAR-SOM-OM37 board.
 *
...
#define CONFIG_EXTRA_ENV_SETTINGS \
	...
	"mmcboot=echo Booting from mmc...; " \
		"run mmcargs; " \
		"bootm ${loadaddr}\0" \
	"loadzimage=load mmc ${mmcdev}:1 ${loadaddr} ${bootfile}\0" \
	"loadfdt=load mmc ${mmcdev}:1 ${fdtaddr} ${fdtfile}\0" \
...
#define CONFIG_SYS_PROMPT		"var-som-om37 # "
